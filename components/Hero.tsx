...
export const Hero: React.FC<HeroProps> = ({ onExploreClick }) => {
  return (
    <section className="relative min-h-[92vh] flex flex-col justify-between items-center px-6 py-8 md:py-12 bg-[#FAF8F5] text-[#121212] overflow-hidden select-none">
      ...
      <div className="relative my-auto flex flex-col items-center justify-center text-center py-12">
        ...
        <div className="absolute -top-12 -right-8 md:-top-16 md:-right-16 z-0">
          <RetroStar size={64} color="#2739e5" variant="pixel" animated />
        </div>
        <div className="absolute -bottom-8 -left-8 md:-bottom-12 md:-left-16 z-0">
        ...
        >
          ...
          <div className="mb-4">
            <img 
              src="/logowayo.svg" 
              alt="Wayo Rodriguez" 
              className="h-16 md:h-24 w-auto object-contain mx-auto drop-shadow-sm hover:scale-105 transition-transform" 
            />
          </div>

          <h1 className="font-serif-display text-6xl sm:text-7xl md:text-9xl text-[#2739e5] tracking-tight leading-none mt-2">
            Porta<span className="font-editorial italic font-normal text-[#121212]">folio</span>
          </h1>
          ...
          <motion.div
            ...
            className="mt-6 inline-flex items-center gap-2 bg-[#2739e5] text-white px-6 py-2 rounded-full text-sm md:text-base font-editorial font-medium shadow-md hover:bg-[#1a28bf] transition-colors"
          >
          ...
          <p className="mt-6 max-w-md text-sm md:text-base text-gray-600 font-medium leading-relaxed px-4">
      ...
      <div className="w-full max-w-6xl flex flex-col sm:flex-row justify-between items-center gap-4 text-xs md:text-sm pt-6 border-t border-gray-200/80">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="order-1 sm:order-2 group flex items-center gap-3 bg-white border-2 border-[#2739e5] text-[#2739e5] hover:bg-[#2739e5] hover:text-white px-6 py-3 rounded-full font-bold shadow-sm transition-all duration-300"
        >
