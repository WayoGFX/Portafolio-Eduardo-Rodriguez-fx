...
import { Video, Palette, Camera } from 'lucide-react';
...
export const WorksSection: React.FC = () => {
  ...
  return (
    <section id="works" className="relative py-12 md:py-20 px-4 sm:px-6 max-w-6xl mx-auto">
      {/* SECTION HEADER matching Reference Image 4 */}
      <div className="relative bg-[#FAF8F5] border-2 border-[#2739e5]/30 rounded-3xl md:rounded-[36px] p-6 sm:p-10 mb-10 shadow-md overflow-hidden">
        ...
        <div className="relative my-6 sm:my-10 flex flex-col items-center justify-center text-center">
          <div className="absolute right-4 sm:right-10 top-0 opacity-80">
            <RetroStar size={44} color="#2739e5" variant="pixel" animated />
          </div>
          ...
          >
            <h2 className="font-serif-display text-4xl sm:text-6xl md:text-7xl text-[#2739e5] tracking-tight">
        ...
        {/* Big Interactive Tabs with Lucide Icons */}
        <div className="flex flex-wrap justify-center items-center gap-2.5 sm:gap-4 pt-4 border-t border-gray-200">
          <button
            onClick={() => setActiveTab('video')}
            className={`flex items-center gap-2.5 px-5 sm:px-7 py-3 rounded-2xl font-bold text-xs sm:text-sm transition-all transform active:scale-95 ${
              activeTab === 'video'
